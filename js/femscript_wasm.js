...
/**
* @param {string} code
* @returns {SyntaxResult | undefined}
*/
export function check_syntax(code) {
    const ptr0 = passStringToWasm0(code, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.check_syntax(ptr0, len0);
    return ret === 0 ? undefined : SyntaxResult.__wrap(ret);
}
...
const SyntaxResultFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_syntaxresult_free(ptr >>> 0));
/**
*/
export class SyntaxResult {
    ...
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(SyntaxResult.prototype);
        obj.__wbg_ptr = ptr;
        SyntaxResultFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        SyntaxResultFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_syntaxresult_free(ptr);
    }
    /**
    * @returns {Uint32Array}
    */
    get pos() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.syntaxresult_pos(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
    ...
    */
    get value() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.syntaxresult_value(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            deferred1_0 = r0;
            deferred1_1 = r1;
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_jsvariable_unwrap = function(arg0) {
        const ret = JsVariable.__unwrap(takeObject(arg0));
        return ret;
    };
    imports.wbg.__wbg_jstoken_unwrap = function(arg0) {
        const ret = JsToken.__unwrap(takeObject(arg0));
        return ret;
    };
    imports.wbg.__wbg_calljs_f032d11ac5d53bb0 = function(arg0, arg1, arg2, arg3) {
        let deferred0_0;
        let deferred0_1;
        try {
            deferred0_0 = arg0;
