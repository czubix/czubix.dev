...
export function execute_code(code) {
    ...
    const ret = wasm.execute_code(ptr0, len0);
    return JsToken.__wrap(ret);
}

const JsTokenFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_jstoken_free(ptr >>> 0));
/**
*/
export class JsToken {
    ...
    */
    get _type() {
        ...
        try {
            ...
            wasm.jstoken__type(retptr, this.__wbg_ptr);
    ...
    */
    get value() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.jstoken_value(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            deferred1_0 = r0;
            deferred1_1 = r1;
    ...
    */
    get list() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.jstoken_list(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
    ...
    */
    get scope() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.jstoken_scope(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var v1 = getArrayJsValueFromWasm0(r0, r1).slice();
            wasm.__wbindgen_free(r0, r1 * 4, 4);
...
const JsVariableFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_jsvariable_free(ptr >>> 0));
/**
*/
export class JsVariable {
    ...
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_jsvariable_free(ptr);
    }
    /**
    * @returns {string}
    */
    get name() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.jsvariable_name(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            deferred1_0 = r0;
            deferred1_1 = r1;
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_random_72272ff03217306b = typeof Math.random == 'function' ? Math.random : notDefined('Math.random');
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('femscript_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
